...
class UniProjectTeamMember(models.Model):
    """Project Team Member — a student participating in a project team.
    ...
    """
    _name = 'uni.project.team.member'
    _description = 'Project Team Member'
    _order = 'team_id, join_date'

    team_id = fields.Many2one('uni.project.team', string='Team',
                              required=True, ondelete='cascade', index=True)
    project_id = fields.Many2one('uni.project', related='team_id.project_id',
    ...
    student_name = fields.Char(related='student_id.name',
                               string='Student Name', store=True, readonly=True)
    student_code = fields.Char(related='student_id.student_code',
                               string='Student Code', store=True, readonly=True)
    ...
    contribution_percentage = fields.Float(string='Contribution %',
                                           ...
                                           tracking=True,
                                           help="Percentage of this member's "
